...
- **entities**:
  ...
  - lab: <lab name from content>
  - doctor: <doctor name from content>
...
> "Inspect `inbox/Scan001.pdf` deeply. Other candidate duplicate to compare: `inbox/IMG_4523.pdf`. Use destination prefix `drive/<domain>/`. Do not read folders: `Private/`, `Legal/`. Return structured report."
