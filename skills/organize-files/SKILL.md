...
- **Short description**, dash-separated: `lab-cbc-results`, `car-insurance-renewal`, `cardiology-visit-notes`.
- **Always English** — even if the file's content is in another language (name it `tax-return-2025.pdf`, never in the document's source-language script).
...
| `analisis-de-sangre.pdf` | `2026-04-15-lab-blood-results.pdf` |
